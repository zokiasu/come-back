-- Restore the transactional RPC used by PATCH /api/releases/:id. The remote
-- migration history contained its original version, but the function itself
-- was missing from the live catalog.
