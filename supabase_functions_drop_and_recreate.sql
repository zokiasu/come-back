-- ============================================
-- SUPPRIMER ET RECRÉER LES FONCTIONS AVEC BONS TYPES
-- À exécuter dans l'éditeur SQL de Supabase
-- ============================================

-- ÉTAPE 1: Supprimer toutes les anciennes fonctions
DROP FUNCTION IF EXISTS get_top_artists_by_releases(integer,date,date,integer);
DROP FUNCTION IF EXISTS get_top_artists_by_musics(integer,date,date,integer);
DROP FUNCTION IF EXISTS get_artist_demographics();
DROP FUNCTION IF EXISTS get_general_stats(integer,date,date);
DROP FUNCTION IF EXISTS get_company_stats(integer,date,date);
DROP FUNCTION IF EXISTS get_temporal_stats(text,text,integer);
DROP FUNCTION IF EXISTS test_function();

-- ÉTAPE 2: Recréer les fonctions avec les bons types

-- Fonction pour top artistes par releases
...
-- Fonction pour top artistes par musiques
...
-- SELECT * FROM get_top_artists_by_releases(2020) LIMIT 3;
-- SELECT * FROM get_top_artists_by_musics(2020) LIMIT 3;
